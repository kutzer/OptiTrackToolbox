        ...
        function Initialize(obj,varargin)
            ...
            if exist(dllPath,'file') ~= 2
                error('OptiTrack:Init:NoSDK',...
                    ...
                    ' -> Download and install the NatNetSDK 2.7 to the toolbox\n',...
                    '    path from the following URL:\n\n',...
                    '    https://d2mzlempwep3hb.cloudfront.net/NatNetSDK/NatNet_SDK_2.7.zip\n\n',...
                    '    Toolbox Path: "%s"'],tboxPath);
            end
